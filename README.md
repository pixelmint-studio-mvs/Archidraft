...
- `PROJECT_OVERVIEW.md` - Business problem and core purpose.
...
- `DEVELOPMENT_ROADMAP.md` - Phase-by-phase execution plan.
- `ENVIRONMENT_SETUP.md` - Prerequisites and installed SDK versions.
- `PROJECT_GLOSSARY.md` - Shared definitions to prevent confusion.
